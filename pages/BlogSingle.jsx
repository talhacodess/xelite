...
function BlogSingle() {
  return (
         ...
         <div className='container-fluid mx-auto'>
                ...
                <div
                  className="md:pt-30 pt-10 md:pb-40 pb-10 bg-cover bg-center bg-no-repeat h-100"
